    ...
    public static String toString(String string) {
        ...
        if (name == null) {
            ...
            for (int i = 1; i < name.length(); i++) {
                if (desTransportTyp[i] < 91 && desTransportTyp[i] > 64) {
                    desTransportTyp[i] = (char) (desTransportTyp[i] + DIFF);
                }
                if (desTransportTyp[i] < 65 && desTransportTyp[i] > 57 ||
                        desTransportTyp[i] > 122 ||
                        desTransportTyp[i] < 48) {
                    desTransportTyp[i] = ' ';
                }
            }
